...
HD_PWD='C:/Users/User/Desktop/half_adder/ha/ha.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log halfadd.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source halfadd.tcl -notrace
